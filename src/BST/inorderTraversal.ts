...
let expected: number[] = [6,9,7,2,15,20,8,7,9]
let inOrderTraversalResult: number[] = inOrderTraversal(unOrderedTree1)
let inOrderTraversalRecursiveResult: number[] = inOrderTraversalRecursive(unOrderedTree1)
